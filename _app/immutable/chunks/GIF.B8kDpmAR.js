import"./disclose-version.Bg9kRutz.js";import{a6 as q,t as x,c as o,r as i,s as f,a3 as L,y as M,a4 as E,A as D,p as J,n as O,a as U}from"./runtime.DBSzk1xQ.js";import{a as m}from"./store.Dy6pcxBO.js";import{a as I,t as G}from"./template.Cv5zbk9r.js";import{s as k}from"./attributes.BaR8ABSh.js";import{d as N}from"./events.FZMNKl5r.js";import{i as W,c as X,b as S,a as T}from"./instruments.B9gjmlYA.js";import{p as l,u as Y}from"./props.CLTgNlsy.js";import{s as A}from"./class.DooIvUr-.js";import{I as $,F as ee}from"./Icon.BPA_qC1x.js";import{b as V}from"./paths.6sx1FV_N.js";function re(r,e,t,a,s){var n=()=>{a(t[r])};t.addEventListener(e,n),n(),(t===document.body||t===window||t===document)&&q(()=>{t.removeEventListener(e,n)})}const te=["success1.gif","success2.gif","success3.gif","success4.gif","success5.gif","gil-cat.gif","happy-snoopy.gif"],ae=["fail1.gif","fail2.gif","fail3.gif","fail4.gif"];function ke(r,e){let t=[];return t=W,t=se(t).slice(0,r),t.map((a,s)=>({index:s,name:a.name,category:a.category,image:a.image,audio:a.audios[Math.floor(Math.random()*a.audios.length)]}))}function se(r){for(let e=r.length;e>0;e--){const t=Math.floor(Math.random()*e);[r[e-1],r[t]]=[r[t],r[e-1]]}return r}function Ie(r){return r[Math.floor(Math.random()*r.length)]}function oe(r){const e=r?te:ae;return e[Math.floor(Math.random()*e.length)]}function ie(r){return r!=null?parseInt(""+Math.random()*r.length):-1}function Ge(r,e){const t=[],a=[];do{const s=ie(r);t.includes(s)||(t.push(s),a.push(r[s]))}while(a.length<e);return a}var ne=G(`<div><div><div class="flex flex-row justify-center items-center w-5/6 h-5/6 rounded-full bg-gray-800
            ...
            border-[1px]
            p-3
        "><!></button> <audio></audio></div>`);function Fe(r,e){let t=l(e,"sound_level_float",15,.5),a=l(e,"track_paused",15,!0),s=l(e,"time",7,0),n=l(e,"tries",7,0),b=l(e,"repeats",7,0),g=E(0),c=E(0);function v(){L(c,0),a(!1),Y(b)}function u(d){if(isNaN(d))return"...";const Z=Math.floor(d/60),C=Math.floor(d%60);return`${Z}:${C<10?`0${C}`:C}`}var p=ue(),h=o(p),y=o(h),F=D(()=>!a());de(y,{get spinning(){return M(F)}}),i(h);var _=f(h,2),z=o(_),H=o(z,!0);x(()=>m(H,u(M(c)))),i(z);var B=f(z,2),K=o(B,!0);x(()=>m(K,u(M(g)))),i(B),i(_);var R=f(_,2),P=o(R);ce(P,{get time(){return s()},set time(d){s(d)},get repeats(){return b()},set repeats(d){b(d)},get tries(){return n()},set tries(d){n(d)}}),i(R);var j=f(R,2);j.__click=[fe,v];var Q=o(j);$(Q,{size:"100%",color:"white",src:ee}),i(j);var w=f(j,2);i(p),x(()=>k(w,"src",e.track_source)),X(w,()=>M(c),d=>L(c,d)),re("duration","durationchange",w,d=>L(g,d)),S(w,a),T(w,t),I(r,p)}N(["click"]);var be=G(`<div class="fixed bottom-0 top-0 h-screen w-screen flex-col items-center justify-start"><div class="fixed bottom-0 top-0 z-50 flex h-full w-full flex-col items-center justify-start p-7"><img> <button class="
							mt-3
							flex
							h-1/6
							w-fit
