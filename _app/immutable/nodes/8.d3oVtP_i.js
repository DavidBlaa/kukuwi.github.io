import"../chunks/disclose-version.Bg9kRutz.js";import{t as k,A as b,D as y,F as w,c as _,r as u,s as B,p as D,a as M}from"../chunks/runtime.ByPQCJTE.js";import{a as g,t as p}from"../chunks/template.CElCRC7T.js";import{p as c,a as n}from"../chunks/props.6q4YRsUj.js";import{i as S}from"../chunks/if.jLSaHWu0.js";import{s as j}from"../chunks/class.CSIqV9wI.js";import{M as C,S as F}from"../chunks/MidiBoardGrid.DAuAq6lK.js";import{i as h}from"../chunks/instruments.4F5DZGXP.js";var G=p('<div class="basis-1/12"><!></div>'),q=p('<div><div class="basis-11/12"><!></div> <!></div>');function z(d,e){let i=c(e,"use_sound_level",3,!0),l=c(e,"board_bg_color",3,"bg-[#252525]"),o=c(e,"use_tile_sounds",3,!0),r=w(.4);var t=q(),a=_(t),v=_(a);C(v,{get sound_level_float(){return b(r)},set sound_level_float(f){y(r,n(f))},get active_tile_list(){return e.active_tile_list},get pause_tile_list(){return e.pause_tile_list},get use_tile_sounds(){return o()},get instruments(){return e.instruments},get onmouseup(){return e.onmouseup}}),u(a);var s=B(a,2);S(s,i,f=>{var m=G(),x=_(m);F(x,{get sound_level_float(){return b(r)},set sound_level_float(A){y(r,n(A))}}),u(m),g(f,m)}),u(t),k(()=>j(t,`
            flex
            justify-stretch
            rounded-2xl
            ${l()??""}
